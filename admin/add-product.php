...
if(isset($_POST['add_product'])){
    ...
    $admin->addProduct($name, $price, $meal_type, $file_name);
        ...
        <div class="row">
            <section class="aside col-lg-2">
                ...
                <div class="tabs">
                    ...
                    <button class="btn btn-primary active"><a href="add-product.php">Add Product</a></button>
            ...
            <section class="main-content col-lg-10">
                ...
                <div class="dashboard-title">
                    <h4 class="heading-title">Add Product</h4>
